...
declare module "asynciterator" {
  ...
  export abstract class AsyncIterator<T> extends EventEmitter {
    ...
    prepend(items: T[] | AsyncIterator<T>): SimpleTransformIterator<T, T>;

    append<T>(items: T[] | AsyncIterator<T>): SimpleTransformIterator<T, T>;

    surround<T>(prepend: T[] | AsyncIterator<T>, append: T[] | AsyncIterator<T>): SimpleTransformIterator<T, T>;
