...
describe("[BinarySearch]", () => {
  ...
  it("findLastIndex: key doesn\'t exist / belongs at the start", () => {
  ...
  it("findLastIndex: key doesn\'t exist / belongs in middle", () => {
  ...
  it("findLastIndex: key doesn\'t exist / belongs at the end", () => {
