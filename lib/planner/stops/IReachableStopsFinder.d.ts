...
export default interface IReachableStopsFinder {
    findReachableStops: (sourceOrTargetStop: ILocation, mode: ReachableStopsFinderMode, maximumDuration: DurationMs, minimumSpeed: SpeedKmH, profileID: string) => Promise<IReachableStop[]>;
}
/**
